        ...
        <div class="header">
            <div class="header-left">
                <a href="index-2.html" class="logo">
                    <img src="assets/img/logo.png" width="35" height="35" alt=""> <span>Laxuman Suppliers</span>
                </a>
            </div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.users') }}"><i class="fa fa-user-md"></i>
                                <span>Users</span></a>
                        </li>
                        <li>
                            <a href="{{ route('admin.category') }}"><i class="fa fa-user-md"></i>
                                <span>Category</span></a>
                        </li>
                        <li>
                            <a href="{{ route('admin.products') }}"><i class="fa fa-wheelchair"></i> <span>Products</span></a>
                        </li>
                        {{-- <li>
